...
class MultiDataset(Dataset.Dataset):
    def __init__(self, vocabulary: Vocabulary, examples, max_arity=2, max_seq_length=3, max_per_type=20, max_neighbors_num=15, precomputed_features=None, is_train=True, train_examples=None, ONR=False):
        ...
        if precomputed_features is not None:
            ...
            if ONR:
                print("Building feature headers (ONR activated)...")
